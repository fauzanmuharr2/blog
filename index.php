...
<head>
	...
	<link rel="stylesheet" href="style.css">
	        ...
	        <link rel="stylesheet" href="/assets/egames/css/animate.css.css">
			<link rel="stylesheet" href="/assets/egames/css/bootstrap.min.css">
			<link rel="stylesheet" href="/assets/egames/css/classy-nav.css">
			<link rel="stylesheet" href="/assets/egames/css/font-awesome.min.css">
			<link rel="stylesheet" href="/assets/egames/css/magnific-popup.css">	
			<link rel="stylesheet" href="/assets/egames/css/nice-select.css">							
			<link rel="stylesheet" href="/assets/egames/css/owl.carousel.min.css">
			<link rel="stylesheet" href="/assets/egames/scss/_fonts.scss">
			<link rel="stylesheet" href="/assets/egames/scss/_mixin.scss">
			<link rel="stylesheet" href="/assets/egames/scss/_responsive.scss">
			<link rel="stylesheet" href="/assets/egames/scss/_theme_color.scss">
			<link rel="stylesheet" href="/assets/egames/scss/_variables.scss">
			<link rel="stylesheet" href="/assets/egames/scss/style.scss">
			<link rel="stylesheet" href="/assets/egames/style.css">
			<link rel="stylesheet" href="/assets/egames/style.css.map">
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12 d-flex align-items-center justify-content-between">
                        <!-- Logo Area -->
                        <div class="logo">
                            <a href="index.html"><img src="/assets/egames/img/core-img/logo.png" alt=""></a>
                        </div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-4 blog-left">
							<div class="thumb">
								<img class="img-fluid" src="/admin/artikel/img/<?php echo $data['foto'] ?>" alt="" style="width:400px; height:400px;">
							</div>
							<div class="detais">
								<ul class="tags">
                ...
                <div class="col-12 col-md-6 col-lg-8">
                    <div class="tab-content" id="video-tabContent">
                        <div class="tab-pane fade show active" id="video-1" role="tabpanel" aria-labelledby="video1">
                            <div class="video-playground bg-img" style="background-image: url(../../assets/egames/img/bg-img/45.jpg);">
                                <!-- Play Button -->
                                <div class="play-btn">
                        ...
                        <div class="tab-pane fade" id="video-2" role="tabpanel" aria-labelledby="video2">
                            <div class="video-playground bg-img" style="background-image: url(../../assets/egames/img/bg-img/46.jpg);">
                                <!-- Play Button -->
                                <div class="play-btn">
                                    <a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="/assets/egames/img/core-img/play.png" alt=""></a>
                                </div>
                        ...
                        <div class="tab-pane fade" id="video-3" role="tabpanel" aria-labelledby="video3">
                            <div class="video-playground bg-img" style="background-image: url(../../assets/egames/img/bg-img/47.jpg);">
                                <!-- Play Button -->
                                <div class="play-btn">
                                    <a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="/assets/egames/img/core-img/play.png" alt=""></a>
                                </div>
                        ...
                        <div class="tab-pane fade" id="video-4" role="tabpanel" aria-labelledby="video4">
                            <div class="video-playground bg-img" style="background-image: url(../../assets/egames/img/bg-img/48.jpg);">
                                <!-- Play Button -->
                                <div class="play-btn">
                                    <a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="/assets/egames/img/core-img/play.png" alt=""></a>
                                </div>
                        ...
                        <div class="tab-pane fade" id="video-5" role="tabpanel" aria-labelledby="video5">
                            <div class="video-playground bg-img" style="background-image: url(../../assets/egames/img/bg-img/49.jpg);">
                                <!-- Play Button -->
                                <div class="play-btn">
                                    <a href="https://www.youtube.com/watch?v=7HKoqNJtMTQ" class="play-button"><img src="/assets/egames/img/core-img/play.png" alt=""></a>
                                </div>
                    ...
                    <div class="mb-100">
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="300ms">
                            <div class="article-thumbnail">
                                <img src="/assets/egames/img/bg-img/6.jpg" alt="">
                            </div>
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="500ms">
                            <div class="article-thumbnail">
                                <img src="/assets/egames/img/bg-img/7.jpg" alt="">
                            </div>
                            <div class="article-content">
                        ...
                        <div class="single-articles-area style-2 d-flex flex-wrap mb-30 wow fadeInUp" data-wow-delay="700ms">
                            <div class="article-thumbnail">
                                <img src="/assets/egames/img/bg-img/8.jpg" alt="">
                            </div>
                            <div class="article-content">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget mb-70 wow fadeInUp" data-wow-delay="100ms">
                            <div class="widget-title">
                                <a href="index.html"><img src="/assets/egames/img/core-img/logo2.png" alt=""></a>
                            </div>
