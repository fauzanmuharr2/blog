          ...
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-6">
                    <button class="btn btn-primary px-4" type="submit" name="save">Login</button>
                  </div>
            ...
            <div class="card text-white bg-primary py-5 d-md-down-none" style="width:44%">
              <div class="card-body text-center">
                <div>
                  <h2></h2>
                  <img src="/assets/admin-template/img/ass.png" alt="GOOGLE" style="height:auto; width:300px">
                </div>
              </div>
            </div>
          </div>
